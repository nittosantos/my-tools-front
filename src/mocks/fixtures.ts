import type { User, Tool, Rental, Category } from "@/types";
...
function generateMockTools(): Tool[] {
  ...
  const originalTools: Tool[] = [
    {
      ...
      description:
        "Furadeira elétrica de alta potência, ideal para trabalhos em madeira, concreto e metal. Inclui kit de brocas.",
    ...
    },
    {
      ...
      description:
        "Serra circular portátil com lâmina de 7.25 polegadas. Perfeita para cortes precisos em madeira.",
      category: "ferramentas_eletricas",
      price_per_day: 30.0,
      image_url:
    ...
    },
    {
      ...
      description:
        "Kit completo com 20 peças de chaves de fenda em vários tamanhos. Ideal para reparos domésticos.",
    ...
    },
    {
      ...
      description:
        "Cortador de grama elétrico leve e fácil de usar. Ideal para jardins pequenos e médios.",
      category: "jardinagem",
      price_per_day: 35.0,
      image_url:
        "https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=400",
    ...
    },
    {
      ...
      description:
        "Betoneira elétrica de 70 litros. Perfeita para pequenas obras e reformas.",
      category: "construcao",
      price_per_day: 50.0,
      image_url:
        "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=400",
  ...
  for (let i = 0; i < 145; i++) {
    ...
    tools.push({
      id: id++,
      title:
        `${toolTitles[titleIndex]} ${i > 0 ? `#${Math.floor(i / toolTitles.length) + 1}` : ""}`.trim(),
